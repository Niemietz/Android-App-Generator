  ...
  return (
    <div className="panel">
      ...
      <div className="field-row">
        <label>
          App name
          <input name="appName" type="text" value={project.appName} onChange={(e) => setP('appName', e.target.value)} />
        </label>
        <label>
          Package name
          <input
      ...
      <div className="field-row three">
        <label>
          Min SDK
          <input type="number" value={Number.parseInt(project.minSdk)} onChange={(e) => setP('minSdk', e.target.valueAsNumber)} />
        </label>
        <label>
          Target SDK
          <input type="number" value={Number.parseInt(project.targetSdk)} onChange={(e) => setP('targetSdk', e.target.valueAsNumber)} />
        </label>
        <label>
          Compile SDK
          <input type="number" value={Number.parseInt(project.compileSdk)} onChange={(e) => setP('compileSdk', e.target.valueAsNumber)} />
        </label>
      </div>
      ...
      <div className="field-row">
        <label>
          Backend base URL
          <input type="text" className="mono" value={project.baseUrl} onChange={(e) => setP('baseUrl', e.target.value)} />
        </label>
