	...
	return (
		<div className="panel">
			...
			<div className="field-row">
				<label>
					Store File Name
					<input type="text" value={signing.storeFilename}
			...
			<div className="field-row">
				<label>
					Key Alias
					<input type="text" className="mono" value={signing.keyAlias}
					       onChange={(e) => setS('keyAlias', e.target.value)}/>
				</label>
				<label>
					Key Password
					<PasswordField className="mono" value={signing.keyPassword}
